...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    Description:"(+1) 732 433 4865",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    Description:"joymichael.manda@rutgers.edu",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    Description:"10 Paul Robeson Blvd",
  }
]
      ...
      <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="est">Machine Leaarning</SelectItem>
                <SelectItem value="cst">Data Analysis</SelectItem>
                <SelectItem value="mst">Web Developement</SelectItem>
              </SelectGroup>
            </SelectContent>
          </Select>
          {/* text area */}
        ...
        xl:order-none mb-8 xl:mb-0">
          <ul className="flex flex-col gap-10">
            {info.map((item, index)=>{
              return <li key={index} className="flex items-center ghap-6">
